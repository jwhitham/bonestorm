...
class Palette:
    def __init__(self) -> None:
        ...
        self.BUTTON_FG = decode_colour("#808000")
        self.BUTTON_ACTIVE_FG = decode_colour("#f0f0a0")
        self.BUTTON_EDGE_FG = decode_colour("#463632")
        self.BUTTON_BG = decode_colour("#261612")
